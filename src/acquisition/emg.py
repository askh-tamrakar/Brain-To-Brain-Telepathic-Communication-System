"""
EMG Acquisition App
Merged/extended from user's emg_unified.py + UI upgrades:
 - Scrollable left control panel (like EEG)
 - Latest packet detail panel
 - Start/Stop acquisition
 - Auto-start recording on acquisition start + Pause/Resume recording
 - Save filename format: data/raw/session/emg/EMG_session_dd-mm-YYYY_HH-MM-SS.json
"""
...
class EMGAcquisitionApp:
    ...
    # Reuse scrollable left panel helper from EEG style
    ...
    def setup_ui(self):
        ...
        self.line_ch0, = self.ax_ch0.plot([], [], linewidth=1.2, label='Ch0 (Flexor)')
        ...
        self.line_ch1, = self.ax_ch1.plot([], [], linewidth=1.2, label='Ch1 (Extensor)')
